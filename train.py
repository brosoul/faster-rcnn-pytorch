...
if __name__ == "__main__":
    ...
    # 从 epoch 100 （50 冻结 + 50 不冻结）继续训练 100 世代（100个不冻结）
    # model_path      = 'logs/ep100-loss0.568-val_loss0.516.pth'
    # 从 epoch 200 （50 冻结 + 150 不冻结）继续训练 50 世代（50个不冻结）
    # model_path      = 'logs/ep200-loss0.458-val_loss0.428.pth'
    # model_path = 'model_data/voc_weights_vgg.pth'
    # model_path      = 'logs/vgg_frcnn/ep150-loss0.518-val_loss0.485.pth'
    
    model_path = 'model_data/resnet50-19c8e357.pth'
    # model_path = 'logs/ep130-loss1.322-val_loss1.189.pth'
    #------------------------------------------------------#
