...
from nets.frcnn_improve import FasterRCNN
from nets.frcnn_training_improve import (FasterRCNNTrainer, get_lr_scheduler,
                                 set_optimizer_lr, weights_init)
from utils.callbacks_improve import EvalCallback, LossHistory
from utils.dataloader_improve import FRCNNDataset, frcnn_dataset_collate
from utils.utils import get_classes, show_config
from utils.utils_fit_improve import fit_one_epoch
...
if __name__ == "__main__":
    ...
    model_path      = 'logs/ep010-loss0.794-val_loss0.542.pth'
    ...
    train_annotation_path   = 'webgen/output/train_anno.txt'
    val_annotation_path     = 'webgen/output/val_anno.txt'
    train_border_path = 'webgen/output/train_border.txt'
    val_border_path = 'webgen/output/val_border.txt'
    
    # # 用于验证流程
    # train_annotation_path   = 'webgen/output/train_anno_test.txt'
    # train_border_path = 'webgen/output/train_border_test.txt'
    ...
    with open(train_border_path, encoding='utf-8') as f:
        train_borders = f.readlines()
    with open(val_border_path, encoding='utf-8') as f:
        val_borders   = f.readlines()
    ...
    if True:
        ...
        train_dataset   = FRCNNDataset(train_lines, train_borders, input_shape, train = True)
        val_dataset     = FRCNNDataset(val_lines, val_borders, input_shape, train = False)
        ...
        #   记录eval的map曲线
        #----------------------#
        eval_callback   = EvalCallback(model_train, input_shape, class_names, num_classes, val_lines, val_borders, log_dir, Cuda, \
